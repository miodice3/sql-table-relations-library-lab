...
#select name of authors, select subgenres name
...
def select_series_title_with_most_human_characters
  #selects the series title with the most human characters
  #"return series title that contains the most human characters"
  "SELECT series.title
  FROM series
